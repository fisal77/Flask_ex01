...
# TODO: connect to a local postgresql database - DONE in the config.py
...
# Association table - Artist to Genre Many-to-Many
artist_genre_table = db.Table('artist_genre_table',
                              db.Column('genre_id', db.Integer, db.ForeignKey('Genre.id'), primary_key=True),
                              db.Column('artist_id', db.Integer, db.ForeignKey('Artist.id'), primary_key=True)
                              )
# Association table - Venue to Genre Many-to-Many
...
class Venue(db.Model):
    ...
    # Many-2-Many relationship with genre
    ...
    # This venue table is parent of show table (child) - One-to-Many
...
class Artist(db.Model):
    ...
    # This artist table is parent of show table (child) - One-to-Many
...
def venues():
    ...
    cities_and_states.sort(key=itemgetter(1, 0))

    now = datetime.now()

    for location_address in cities_and_states:
        venues_list = []
        for venue in venues:
            if (venue.city == location_address[0]) and (venue.state == location_address[1]):
        ...
        data.append({
            "city": location_address[0],
            "state": location_address[1],
            "venues": venues_list
        })
